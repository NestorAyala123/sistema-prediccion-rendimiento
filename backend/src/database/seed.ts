...
async function seed() {
  ...
  const estudiantes = await estudianteModel.insertMany([
    ...
    {
      id_estudiante: '5566778899',
      nombres: 'Omar',
      apellidos: 'Roldan',
      email: 'oroldan@universidad.edu',
      password: passwordHash,
      telefono: '0998877665',
      semestre_actual: 3,
      carrera: 'Ingeniería en Sistemas',
  ...
  const predicciones = await prediccionModel.insertMany([
    ...
    },
    {
      ...
      factores_clave: 'Rendimiento aceptable (7.8), necesita mejorar consistencia',
      metricas: {
        promedio_actual: 7.8,
      ...
      recomendaciones: ['Aumentar horas de estudio', 'Mejorar técnicas de aprendizaje'],
      estado_prediccion: 'Completado',
      modelo_usado: 'Random Forest v1.0',
    },
    {
      ...
      factores_clave: 'Rendimiento regular (7.2), puede mejorar con dedicación',
      metricas: {
        promedio_actual: 7.2,
      ...
      recomendaciones: ['Mejorar asistencia', 'Establecer horarios de estudio regulares'],
      estado_prediccion: 'Completado',
      modelo_usado: 'Random Forest v1.0',
    },
    {
      ...
      factores_clave: 'Rendimiento deficiente (5.8), baja asistencia, requiere apoyo urgente',
      metricas: {
        promedio_actual: 5.8,
        porcentaje_asistencia: 55,
    ...
    },
    {
      ...
      factores_clave: 'Muy buen rendimiento (8.5), compromiso académico sólido',
      metricas: {
        promedio_actual: 8.5,
      ...
      recomendaciones: ['Mantener el buen desempeño', 'Considerar becas de excelencia'],
      estado_prediccion: 'Completado',
      modelo_usado: 'Random Forest v1.0',
    },
  ]);
